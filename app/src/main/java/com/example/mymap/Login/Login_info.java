...
public class Login_info extends AppCompatActivity {
        ...
        continue_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if (mname.equals("") || !mname.contains(" ")){
                ...
                if (mlast.equals("") || mlast.length()<12){
                    last_name_layout.setError("Enter Valid Aadhar No");
                    return;
                }
    ...
    protected void onStart() {
        ...
        if(firebaseUser!=null){
            Intent intent=new Intent(Login_info.this, Bottom_view.MapsActivity.class);
            startActivity(intent);
            finish();
        }
        super.onStart();
